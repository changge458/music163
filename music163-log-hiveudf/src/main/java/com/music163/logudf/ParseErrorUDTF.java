...
@Description(name = "parseError",
        value = "select parseError(line) ===> server_time,remote_ip,country,,province,client_time,deviceId,appChannel,appVersion,deviceStyle,osType,appPlatform,,createdAtMs,errorBrief,errorDetail\t")
...
public class ParseErrorUDTF extends GenericUDTF {
    ...
    private List<String> fields2 = MysqlUtil.getKeywords("appErrorLogs");
    private List<JavaStringObjectInspector> ois = oiCopy("appBaseLog");
    private List<JavaStringObjectInspector> ois2 = oiCopy("appErrorLogs");
    ...
    public void process(Object[] record) throws HiveException {
        ...
        for (String json : list) {
            //server_time	remote_ip	country		province	client_time  	deviceId	appChannel	appVersion	deviceStyle	osType	appPlatform		createdAtMs	errorBrief	errorDetail
