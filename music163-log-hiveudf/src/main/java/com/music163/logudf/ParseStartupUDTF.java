 ...
 * 日志聚合体解析表生成函数
 */
@Description(name = "parseStartup",
        value = "select parseStartup(line) ===> server_time, remote_ip, client_time, tenantid, deviceid, appversion, appchannel, appplatform, ostype, devicestyle, network, carrier, brand, screenSize\t")
...
public class ParseStartupUDTF extends GenericUDTF {
    ...
    private List<String> fields2 = MysqlUtil.getKeywords("appStartupLogs");
    private List<JavaStringObjectInspector> ois = oiCopy("appBaseLog");
    private List<JavaStringObjectInspector> ois2 = oiCopy("appStartupLogs");
    ...
    public void process(Object[] record) throws HiveException {
        ...
        for (String json : list) {
            //server_time	remote_ip	country		province	client_time  	deviceId	appChannel	appVersion	deviceStyle	osType	appPlatform logType	createdAtMs	carrier	country	brand	network	province	screenSize
